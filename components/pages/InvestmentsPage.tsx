            ...
            <Card>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                    ...
                    <div>
                        ...
                        <p className="text-2xl font-bold text-white">${totalCost.toLocaleString('en-US', {minimumFractionDigits: 2})}</p>
                    </div>
                     <div>
                        ...
                        <tbody>
                            {investments.map((inv) => {
                                ...
                                <tr key={inv.id} className="border-b border-gray-700 last:border-b-0 hover:bg-gray-700/50">
                                    ...
                                    <td className="p-4 text-gray-300">${inv.avgPrice.toFixed(2)}</td>
                                    <td className="p-4 text-gray-300">${inv.currentPrice.toFixed(2)}</td>
                                    <td className="p-4 font-semibold text-white">${marketValue.toLocaleString('en-US', {minimumFractionDigits: 2})}</td>
